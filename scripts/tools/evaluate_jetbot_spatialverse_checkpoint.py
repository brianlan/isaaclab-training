...
parser = argparse.ArgumentParser(description="Rollout-based evaluator for Isaac-Jetbot-SpatialVerse checkpoints.")
parser.add_argument("--task", type=str, default="Isaac-Jetbot-SpatialVerse-839920-v0")
