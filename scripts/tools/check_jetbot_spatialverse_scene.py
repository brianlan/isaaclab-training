...
"""Smoke-test for the SpatialVerse Jetbot pilot scene.

Loads ``Isaac-Jetbot-SpatialVerse-839920-v0`` with a single environment,
...
* Root height dropping below 0.06 m (wheeled robot near-ground threshold)

This script is the hard gate before PPO training.
...
parser = argparse.ArgumentParser(
    description="Smoke-test: load the SpatialVerse Jetbot scene and run 200 zero-action steps."
)
...
TASK_ID = "Isaac-Jetbot-SpatialVerse-839920-v0"
NUM_STEPS = 200
LOG_INTERVAL = 50
# Jetbot is a wheeled robot with spawn height 0.14m; allow 0.08m margin for ground clearance
MIN_ROOT_HEIGHT = 0.06
